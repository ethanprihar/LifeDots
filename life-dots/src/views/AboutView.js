    ...
    render()
    {
        ...
        <div style={about_style}>
            ...
            <div style={text_style}>
                ...
                <p>Each dot can perceive the size and signal values of all dots, the amount of food, the size of traps, and the presence of walls in a fixed radius around itself determined by its genetic code. All these values are sent as input to a neural network, the weights of which are determined by the dot’s genetic code. The neural network has ten outputs. Nine of the outputs correspond to the eight adjacent cells and the cell the dot is currently in. Of these nine outputs, the output with highest value determines which cell the dot moves to. The tenth output is bounded between negative one and one and is used as the dot’s signal value.</p>
            </div>
            <div>
